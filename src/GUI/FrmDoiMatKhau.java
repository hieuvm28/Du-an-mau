...
public class FrmDoiMatKhau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSignUp.setText("Đổi mật khẩu");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(txtUser, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(cbbRole, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(58, 58, 58)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public void setModel(){
        String maNV = ShareHelper.USER.getMaNhanVien();
        NhanVien model = dao.findById(maNV);
        txtUser.setText(model.getMaNhanVien());
        txtName.setText(model.getNameNV());
        if (model.isRole()) {
            cbbRole.setSelectedItem("Trưởng phòng");
        } else {
            cbbRole.setSelectedItem("Nhân viên");
        }
    }
    ...
    public boolean check() {
        ...
        if (String.valueOf(txtNewPass.getPassword()).equals("")) {
            JOptionPane.showMessageDialog(this, "Không được để trống Password");
        ...
        if (pass.equalsIgnoreCase(nv.getMatKhau())) {
            if (newPass.equalsIgnoreCase(pass)) {
                ...
                if (!conPass.equalsIgnoreCase(newPass)) {
